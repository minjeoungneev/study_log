...
The main idea is sampling with replacement, addressing the limitation of k-fold data split in generating as many subsets as possible. It estimates the distribution of the original data by generating statistic from each bootstrapped sample.
